...
class nngraphListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by nngraphParser#modelItem.
    def enterModelItem(self, ctx:nngraphParser.ModelItemContext):
        pass

    # Exit a parse tree produced by nngraphParser#modelItem.
    def exitModelItem(self, ctx:nngraphParser.ModelItemContext):
        pass
    ...
    # Enter a parse tree produced by nngraphParser#graphItem.
    def enterGraphItem(self, ctx:nngraphParser.GraphItemContext):
        pass

    # Exit a parse tree produced by nngraphParser#graphItem.
    def exitGraphItem(self, ctx:nngraphParser.GraphItemContext):
        pass
    ...
    # Enter a parse tree produced by nngraphParser#number.
    def enterNumber(self, ctx:nngraphParser.NumberContext):
        pass

    # Exit a parse tree produced by nngraphParser#number.
    def exitNumber(self, ctx:nngraphParser.NumberContext):
        pass
